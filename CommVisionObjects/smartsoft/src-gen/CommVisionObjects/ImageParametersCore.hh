...
//--------------------------------------------------------------------------
#ifndef COMMVISIONOBJECTS_IMAGEPARAMETERS_CORE_H_
#define COMMVISIONOBJECTS_IMAGEPARAMETERS_CORE_H_

#include "CommVisionObjects/ImageParametersData.hh"
#include "CommVisionObjects/enumFormatType.hh"
...
protected:
	// data structure
	CommVisionObjectsIDL::ImageParameters idl_ImageParameters;
	
public:
	// give a publicly accessible type-name for the template parameter IDL
	typedef CommVisionObjectsIDL::ImageParameters DATATYPE;
	...
	static inline std::string identifier(void) { return "CommVisionObjects::ImageParameters"; }
	...
	inline CommVisionObjects::FormatType getFormat() const { return CommVisionObjects::FormatType(idl_ImageParameters.format); }
	inline ImageParametersCore& setFormat(const CommVisionObjects::FormatType &format) { idl_ImageParameters.format = format; return *this; }
...
#endif /* COMMVISIONOBJECTS_IMAGEPARAMETERS_CORE_H_ */
