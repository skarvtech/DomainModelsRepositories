...
//--------------------------------------------------------------------------
#ifndef COMMVISIONOBJECTS_DEPTHFORMATTYPE_ENUM_H_
#define COMMVISIONOBJECTS_DEPTHFORMATTYPE_ENUM_H_
...
namespace CommVisionObjects {
	...
	private:
		CommVisionObjectsIDL::DepthFormatType value;
	...
	public:
		...
		DepthFormatType(CommVisionObjectsIDL::DepthFormatType e) {
			value = e;
		}
		
		//const CommVisionObjectsIDL::DepthFormatType& get() const { return value; }
