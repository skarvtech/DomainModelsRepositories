...
//--------------------------------------------------------------------------
#ifndef COMMVISIONOBJECTS_COMMDEPTHIMAGE_DATA_H_
#define COMMVISIONOBJECTS_COMMDEPTHIMAGE_DATA_H_
...
namespace CommVisionObjectsIDL 
{
	...
	struct CommDepthImage
	{
		unsigned int width;
		unsigned int height;
		CommVisionObjectsIDL::DepthFormatType format;
...
#endif /* COMMVISIONOBJECTS_COMMDEPTHIMAGE_DATA_H_ */
