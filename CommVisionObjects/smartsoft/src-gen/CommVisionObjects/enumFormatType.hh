...
//--------------------------------------------------------------------------
#ifndef COMMVISIONOBJECTS_FORMATTYPE_ENUM_H_
#define COMMVISIONOBJECTS_FORMATTYPE_ENUM_H_
...
namespace CommVisionObjects {
	...
	class FormatType {
	private:
		CommVisionObjectsIDL::FormatType value;
	...
	public:
		...
		FormatType(CommVisionObjectsIDL::FormatType e) {
			value = e;
		}
		
		//const CommVisionObjectsIDL::FormatType& get() const { return value; }
