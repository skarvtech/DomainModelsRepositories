...
//--------------------------------------------------------------------------
#ifndef COMMVISIONOBJECTS_COMMVIDEOIMAGE_H_
#define COMMVISIONOBJECTS_COMMVIDEOIMAGE_H_
...
class CommVideoImage : public CommVideoImageCore {
	public:
		 ...
		 */
		// CommVideoImage(const CommVisionObjects::ImageParameters &parameter, const std::vector<unsigned char> &data, const CommBasicObjects::CommPose3d &sensor_pose, const CommBasicObjects::CommBaseState &base_state, const bool &is_valid, const unsigned int &seq_count, const std::vector<double> &intrinsic_m, const std::vector<double> &distortion_m, const CommVisionObjects::ImageDistortionModel &distortion_model = CommVisionObjects::ImageDistortionModel());
		...
		inline CommVisionObjectsIDL::ImageParameters getParameter() const
		{
			return CommVisionObjectsIDL::ImageParameters(
					idl_CommVideoImage.parameter);
		}
		inline void setParameter(
				const CommVisionObjectsIDL::ImageParameters &parameter)
		{
...
#endif /* COMMVISIONOBJECTS_COMMVIDEOIMAGE_H_ */
