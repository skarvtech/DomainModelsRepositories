...
CommDepthImage::CommDepthImage(const unsigned int &width, const unsigned int &height, const CommVisionObjects::DepthFormatType &format, const unsigned int &pixel_size, const double &min_distcance, const double &max_distcance, const std::vector<unsigned char> &data, const std::vector<double> &intrinsic_m, const std::vector<double> &extrinsic_m, const std::vector<double> &stereo_m, const std::vector<double> &distortion_m, const unsigned int &seq_count, const bool &is_valid, const CommVisionObjects::ImageDistortionModel &distortion_model)
