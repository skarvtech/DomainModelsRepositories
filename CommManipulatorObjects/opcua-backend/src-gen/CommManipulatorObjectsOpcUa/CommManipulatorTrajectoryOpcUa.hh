...
// serialization for CommManipulatorTrajectory
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommManipulatorTrajectory *obj, std::string name)
{
