...
// serialization for CommGripperEventParameter
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommGripperEventParameter *obj, std::string name)
{
