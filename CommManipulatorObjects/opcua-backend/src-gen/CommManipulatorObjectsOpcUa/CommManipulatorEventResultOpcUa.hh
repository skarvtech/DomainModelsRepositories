...
// serialization for CommManipulatorEventResult
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommManipulatorEventResult *obj, std::string name)
{
