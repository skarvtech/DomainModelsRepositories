...
// serialization for CommMobileManipulatorState
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommMobileManipulatorState *obj, std::string name)
{
