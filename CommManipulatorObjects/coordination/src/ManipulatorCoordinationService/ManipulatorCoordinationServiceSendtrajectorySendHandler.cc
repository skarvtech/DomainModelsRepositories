#include "ManipulatorCoordinationServiceSendtrajectorySendHandler.hh"
...
CommManipulatorObjects::CommManipulatorTrajectory ManipulatorCoordinationServiceSendtrajectorySendHandler::handleSend(std::string inString){
