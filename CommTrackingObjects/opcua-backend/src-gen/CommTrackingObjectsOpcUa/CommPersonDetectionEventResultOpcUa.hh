...
// serialization for CommPersonDetectionEventResult
template <>
inline IDescription::shp_t SelfDescription(CommTrackingObjects::CommPersonDetectionEventResult *obj, std::string name)
{
