...
// serialization for CommDetectedMarkerEventState
template <>
inline IDescription::shp_t SelfDescription(CommTrackingObjects::CommDetectedMarkerEventState *obj, std::string name)
{
