...
// serialization for CommDetectedMarkerEventParameter
template <>
inline IDescription::shp_t SelfDescription(CommTrackingObjects::CommDetectedMarkerEventParameter *obj, std::string name)
{
