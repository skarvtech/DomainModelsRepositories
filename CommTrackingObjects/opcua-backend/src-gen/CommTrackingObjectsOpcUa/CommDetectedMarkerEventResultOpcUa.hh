...
// serialization for CommDetectedMarkerEventResult
template <>
inline IDescription::shp_t SelfDescription(CommTrackingObjects::CommDetectedMarkerEventResult *obj, std::string name)
{
