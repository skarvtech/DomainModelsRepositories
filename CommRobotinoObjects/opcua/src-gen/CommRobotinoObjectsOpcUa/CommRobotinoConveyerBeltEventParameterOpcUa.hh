...
template <>
ComplexType::shp_t SelfDescription(CommRobotinoObjects::CommRobotinoConveyerBeltEventParameter *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getOldState()), "RobotinoConveyerBeltEventType")
	);
	return ret;
} // end SelfDescription
