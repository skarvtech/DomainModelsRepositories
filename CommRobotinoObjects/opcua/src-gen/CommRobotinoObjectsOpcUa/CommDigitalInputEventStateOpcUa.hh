...
template <>
ComplexType::shp_t SelfDescription(CommRobotinoObjects::CommDigitalInputEventState *obj, std::string name)
{
	...
	ret->add(
		SeRoNet::CommunicationObjects::Description::IDescription::shp_t(
			new SeRoNet::CommunicationObjects::Description::ElementBool(
				"digitalInputValues",
				std::bind(&CommRobotinoObjects::CommDigitalInputEventState::getDigitalInputValues, obj),
				std::bind(&CommRobotinoObjects::CommDigitalInputEventState::setDigitalInputValues, obj, std::placeholders::_1)
			)
		)
	);
	return ret;
