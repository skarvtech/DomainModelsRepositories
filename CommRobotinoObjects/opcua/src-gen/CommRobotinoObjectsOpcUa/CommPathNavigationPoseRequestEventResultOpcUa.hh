...
template <>
ComplexType::shp_t SelfDescription(CommRobotinoObjects::CommPathNavigationPoseRequestEventResult *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getState()), "NodeRequestAnserType")
	);
	return ret;
} // end SelfDescription
