...
template <>
ComplexType::shp_t SelfDescription(CommRobotinoObjects::CommDigitalInputEventResult *obj, std::string name)
{
	...
	ret->add(
		SeRoNet::CommunicationObjects::Description::IDescription::shp_t(
			new SeRoNet::CommunicationObjects::Description::ElementBool(
				"digitalInputValues",
				std::bind(&CommRobotinoObjects::CommDigitalInputEventResult::getDigitalInputValues, obj),
				std::bind(&CommRobotinoObjects::CommDigitalInputEventResult::setDigitalInputValues, obj, std::placeholders::_1)
			)
		)
	);
	return ret;
