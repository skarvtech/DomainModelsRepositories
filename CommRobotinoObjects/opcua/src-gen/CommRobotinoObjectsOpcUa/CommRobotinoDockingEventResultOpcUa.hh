...
template <>
ComplexType::shp_t SelfDescription(CommRobotinoObjects::CommRobotinoDockingEventResult *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getState()), "RobotinoDockingEventType")
	);
	return ret;
} // end SelfDescription
