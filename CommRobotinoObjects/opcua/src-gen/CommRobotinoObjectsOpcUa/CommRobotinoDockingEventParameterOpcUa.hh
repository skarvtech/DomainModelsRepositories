...
// serialization for CommRobotinoDockingEventParameter
template <>
ComplexType::shp_t SelfDescription(CommRobotinoObjects::CommRobotinoDockingEventParameter *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getOldState()), "RobotinoDockingEventType")
	);
	return ret;
} // end SelfDescription
