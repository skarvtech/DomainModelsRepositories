...
// serialization for CommCoordinatedNavigationResourceResponse
template <>
inline IDescription::shp_t SelfDescription(CommRobotinoObjects::CommCoordinatedNavigationResourceResponse *obj, std::string name)
{
