...
// serialization for CommCoordinatedNavigationDataResponse
template <>
inline IDescription::shp_t SelfDescription(CommRobotinoObjects::CommCoordinatedNavigationDataResponse *obj, std::string name)
{
