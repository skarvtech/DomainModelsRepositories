...
// serialization for CommCoordinatedNavigationResourceRequest
template <>
inline IDescription::shp_t SelfDescription(CommRobotinoObjects::CommCoordinatedNavigationResourceRequest *obj, std::string name)
{
