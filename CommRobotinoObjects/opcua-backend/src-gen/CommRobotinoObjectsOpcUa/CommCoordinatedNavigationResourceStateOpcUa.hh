...
// serialization for CommCoordinatedNavigationResourceState
template <>
inline IDescription::shp_t SelfDescription(CommRobotinoObjects::CommCoordinatedNavigationResourceState *obj, std::string name)
{
