...
// serialization for CommRobotinoPowerOutputValue
template <>
inline IDescription::shp_t SelfDescription(CommRobotinoObjects::CommRobotinoPowerOutputValue *obj, std::string name)
{
