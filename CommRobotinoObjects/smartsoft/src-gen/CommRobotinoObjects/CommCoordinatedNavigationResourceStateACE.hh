...
//--------------------------------------------------------------------------
#ifndef COMMROBOTINOOBJECTS_COMMCOORDINATEDNAVIGATIONRESOURCESTATE_ACE_H_
#define COMMROBOTINOOBJECTS_COMMCOORDINATEDNAVIGATIONRESOURCESTATE_ACE_H_

#include "CommRobotinoObjects/CommCoordinatedNavigationResourceState.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommCoordinatedNavigationResourceState
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommRobotinoObjectsIDL::CommCoordinatedNavigationResourceState &data);

// de-serialization operator for DataStructure CommCoordinatedNavigationResourceState
...
#endif /* COMMROBOTINOOBJECTS_COMMCOORDINATEDNAVIGATIONRESOURCESTATE_ACE_H_ */
