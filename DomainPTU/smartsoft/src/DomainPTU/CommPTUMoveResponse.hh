...
#ifndef DOMAINPTU_COMMPTUMOVERESPONSE_H_
#define DOMAINPTU_COMMPTUMOVERESPONSE_H_
...
class CommPTUMoveResponse : public CommPTUMoveResponseCore {
	public:
		 ...
		 */
		// CommPTUMoveResponse(const CommBasicObjects::CommPose3d &devicePose, const CommBasicObjects::CommBaseState &stateBase, const DomainPTU::PTUMoveStatus &status);
		 ...
		 */
		inline void set_status(DomainPTU::PTUMoveStatus status) {
			idl_CommPTUMoveResponse.status =  status;
		}
...
#endif /* DOMAINPTU_COMMPTUMOVERESPONSE_H_ */
