...
//--------------------------------------------------------------------------
#ifndef DOMAINPTU_COMMPTUMOVEREQUEST_CORE_H_
#define DOMAINPTU_COMMPTUMOVEREQUEST_CORE_H_
...
protected:
	// data structure
	DomainPTUIDL::CommPTUMoveRequest idl_CommPTUMoveRequest;
	
public:
	// give a publicly accessible type-name for the template parameter IDL
	typedef DomainPTUIDL::CommPTUMoveRequest DATATYPE;
	...
	static inline std::string identifier(void) { return "DomainPTU::CommPTUMoveRequest"; }
	...
	inline DomainPTU::PTUMoveFlag getFlag() const { return DomainPTU::PTUMoveFlag(idl_CommPTUMoveRequest.flag); }
	inline CommPTUMoveRequestCore& setFlag(const DomainPTU::PTUMoveFlag &flag) { idl_CommPTUMoveRequest.flag = flag; return *this; }
};

} /* namespace DomainPTU */
#endif /* DOMAINPTU_COMMPTUMOVEREQUEST_CORE_H_ */
