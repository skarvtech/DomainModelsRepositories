...
//--------------------------------------------------------------------------
#ifndef COMMBASICOBJECTS_COMMBUMPERSTATE_ACE_H_
#define COMMBASICOBJECTS_COMMBUMPERSTATE_ACE_H_

#include "CommBasicObjects/CommBumperState.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommBumperState
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommBasicObjectsIDL::CommBumperState &data);

// de-serialization operator for DataStructure CommBumperState
...
#endif /* COMMBASICOBJECTS_COMMBUMPERSTATE_ACE_H_ */
