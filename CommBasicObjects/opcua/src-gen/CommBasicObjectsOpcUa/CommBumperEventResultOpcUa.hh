...
// serialization for CommBumperEventResult
template <>
ComplexType::shp_t SelfDescription(CommBasicObjects::CommBumperEventResult *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getState()), "BumperEventType")
	);
	return ret;
} // end SelfDescription
