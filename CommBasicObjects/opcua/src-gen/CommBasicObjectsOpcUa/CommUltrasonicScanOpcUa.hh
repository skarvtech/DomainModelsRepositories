...
// serialization for CommUltrasonicScan
template <>
ComplexType::shp_t SelfDescription(CommBasicObjects::CommUltrasonicScan *obj, std::string name)
{
	...
	ret->add(
		SelfDescription(&(obj->getScanPoints()), "CommPose3d")
	);
	// add intensities
	ret->add(
		SeRoNet::CommunicationObjects::Description::IDescription::shp_t(
			new SeRoNet::CommunicationObjects::Description::ElementDouble(
				"intensities",
				std::bind(&CommBasicObjects::CommUltrasonicScan::getIntensities, obj),
				std::bind(&CommBasicObjects::CommUltrasonicScan::setIntensities, obj, std::placeholders::_1)
			)
		)
	);
	return ret;
