...
template <>
ComplexType::shp_t SelfDescription(CommBasicObjects::CommVoid *obj, std::string name)
{
	...
	ret->add(
		SeRoNet::CommunicationObjects::Description::IDescription::shp_t(
			new SeRoNet::CommunicationObjects::Description::ElementInt32(
				"dummy",
				std::bind(&CommBasicObjects::CommVoid::getDummy, obj),
				std::bind(&CommBasicObjects::CommVoid::setDummy, obj, std::placeholders::_1)
			)
		)
	);
	return ret;
