...
// serialization for CommDevicePoseState
template <>
ComplexType::shp_t SelfDescription(CommBasicObjects::CommDevicePoseState *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getStateBase()), "CommBaseState")
	);
	ret->add(
		SelfDescription(&(obj->getDevicePose()), "CommPose3d")
	);
	return ret;
} // end SelfDescription
