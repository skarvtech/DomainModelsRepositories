...
// serialization for PropertySetEntry
template <>
ComplexType::shp_t SelfDescription(CommBasicObjects::PropertySetEntry *obj, std::string name)
{
	...
	ret->add(
		SeRoNet::CommunicationObjects::Description::IDescription::shp_t(
			new SeRoNet::CommunicationObjects::Description::ElementString(
				"key",
				std::bind(&CommBasicObjects::PropertySetEntry::getKey, obj),
				std::bind(&CommBasicObjects::PropertySetEntry::setKey, obj, std::placeholders::_1)
			)
		)
	);
	// add parent
	ret->add(
		SeRoNet::CommunicationObjects::Description::IDescription::shp_t(
			new SeRoNet::CommunicationObjects::Description::ElementUInt32(
				"parent",
				std::bind(&CommBasicObjects::PropertySetEntry::getParent, obj),
				std::bind(&CommBasicObjects::PropertySetEntry::setParent, obj, std::placeholders::_1)
			)
		)
	);
	return ret;
