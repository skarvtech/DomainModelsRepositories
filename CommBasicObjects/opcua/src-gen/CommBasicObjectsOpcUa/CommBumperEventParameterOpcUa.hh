...
// serialization for CommBumperEventParameter
template <>
ComplexType::shp_t SelfDescription(CommBasicObjects::CommBumperEventParameter *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getOldState()), "BumperEventType")
	);
	return ret;
} // end SelfDescription
