...
// serialization for CommNavigationTopologyConnection
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommNavigationTopologyConnection *obj, std::string name)
{
