...
// serialization for CommNavigationTopologyMap
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommNavigationTopologyMap *obj, std::string name)
{
