...
// serialization for CommNavigationTopologyPart
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommNavigationTopologyPart *obj, std::string name)
{
