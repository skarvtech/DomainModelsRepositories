...
CommCdlGoalEventParameter::CommCdlGoalEventParameter(const CommNavigationObjects::CdlGoalEventType &oldState)
:	CommCdlGoalEventParameterCore() // base constructor sets default values as defined in the model
{
	setOldState(oldState);
}
 */

CommCdlGoalEventParameter::CommCdlGoalEventParameter(const CommCdlGoalEventParameterCore &commCdlGoalEventParameter)
:	CommCdlGoalEventParameterCore(commCdlGoalEventParameter)
{  }

CommCdlGoalEventParameter::CommCdlGoalEventParameter(const DATATYPE &commCdlGoalEventParameter)
:	CommCdlGoalEventParameterCore(commCdlGoalEventParameter)
{  }
...
{
	idl_CommCdlGoalEventParameter.oldState = r;
}
