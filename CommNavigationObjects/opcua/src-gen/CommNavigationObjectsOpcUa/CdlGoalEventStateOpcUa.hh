...
// serialization for CdlGoalEventState
template <>
ComplexType::shp_t SelfDescription(CommNavigationObjects::CdlGoalEventState *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getNewState()), "CdlGoalEventType")
	);
	return ret;
} // end SelfDescription
