...
template <>
ComplexType::shp_t SelfDescription(CommNavigationObjects::CommCdlRobotBlockedEventParameter *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getOldState()), "CdlRobotBlockEventType")
	);
	return ret;
} // end SelfDescription
