...
//--------------------------------------------------------------------------
#ifndef COMMPTUOBJECTS_PTUTAGTYPE_ENUM_H_
#define COMMPTUOBJECTS_PTUTAGTYPE_ENUM_H_

#include <CommPTUObjects/enumPTUTagTypeData.hh>
...
namespace CommPTUObjects {
	...
	class PTUTagType {
	private:
		CommPTUObjectsIDL::PTUTagType value;
	...
	public:
		...
		PTUTagType(CommPTUObjectsIDL::PTUTagType e) {
			value = e;
		}
		
		//const CommPTUObjectsIDL::PTUTagType& get() const { return value; }
