...
//--------------------------------------------------------------------------
#ifndef COMMOBJECTRECOGNITIONOBJECTS_COMMOBJECTRELATION_ACE_H_
#define COMMOBJECTRECOGNITIONOBJECTS_COMMOBJECTRELATION_ACE_H_

#include "CommObjectRecognitionObjects/CommObjectRelation.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommObjectRelation
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommObjectRecognitionObjectsIDL::CommObjectRelation &data);

// de-serialization operator for DataStructure CommObjectRelation
...
#endif /* COMMOBJECTRECOGNITIONOBJECTS_COMMOBJECTRELATION_ACE_H_ */
