...
//--------------------------------------------------------------------------
#ifndef COMMOBJECTRECOGNITIONOBJECTS_COMMSYMBOLDETECTOREVENTRESULT_ACE_H_
#define COMMOBJECTRECOGNITIONOBJECTS_COMMSYMBOLDETECTOREVENTRESULT_ACE_H_

#include "CommObjectRecognitionObjects/CommSymbolDetectorEventResult.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommSymbolDetectorEventResult
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommObjectRecognitionObjectsIDL::CommSymbolDetectorEventResult &data);

// de-serialization operator for DataStructure CommSymbolDetectorEventResult
...
#endif /* COMMOBJECTRECOGNITIONOBJECTS_COMMSYMBOLDETECTOREVENTRESULT_ACE_H_ */
