...
// serialization for CommObjectRecognitionId
template <>
inline IDescription::shp_t SelfDescription(CommObjectRecognitionObjects::CommObjectRecognitionId *obj, std::string name)
{
