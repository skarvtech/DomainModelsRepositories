...
// serialization for CommObjectRecognitionEventState
template <>
inline IDescription::shp_t SelfDescription(CommObjectRecognitionObjects::CommObjectRecognitionEventState *obj, std::string name)
{
