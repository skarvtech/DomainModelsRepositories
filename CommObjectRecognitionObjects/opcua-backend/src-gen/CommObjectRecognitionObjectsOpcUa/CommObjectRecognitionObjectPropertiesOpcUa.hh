...
// serialization for CommObjectRecognitionObjectProperties
template <>
inline IDescription::shp_t SelfDescription(CommObjectRecognitionObjects::CommObjectRecognitionObjectProperties *obj, std::string name)
{
