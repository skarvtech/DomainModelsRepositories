...
// serialization for SimpleObjectEventState
template <>
inline IDescription::shp_t SelfDescription(CommObjectRecognitionObjects::SimpleObjectEventState *obj, std::string name)
{
