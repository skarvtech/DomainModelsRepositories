...
// serialization for CommSimpleObjectEventResult
template <>
inline IDescription::shp_t SelfDescription(CommObjectRecognitionObjects::CommSimpleObjectEventResult *obj, std::string name)
{
