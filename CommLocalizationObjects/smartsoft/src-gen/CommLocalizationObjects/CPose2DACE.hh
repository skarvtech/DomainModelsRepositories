...
//--------------------------------------------------------------------------
#ifndef COMMLOCALIZATIONOBJECTS_CPOSE2D_ACE_H_
#define COMMLOCALIZATIONOBJECTS_CPOSE2D_ACE_H_

#include "CommLocalizationObjects/CPose2D.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CPose2D
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommLocalizationObjectsIDL::CPose2D &data);

// de-serialization operator for DataStructure CPose2D
...
#endif /* COMMLOCALIZATIONOBJECTS_CPOSE2D_ACE_H_ */
