...
//--------------------------------------------------------------------------
#ifndef COMMLOCALIZATIONOBJECTS_COMMVIEWPOINTLOCATIONS_ACE_H_
#define COMMLOCALIZATIONOBJECTS_COMMVIEWPOINTLOCATIONS_ACE_H_

#include "CommLocalizationObjects/CommViewpointLocations.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommViewpointLocations
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommLocalizationObjectsIDL::CommViewpointLocations &data);

// de-serialization operator for DataStructure CommViewpointLocations
...
#endif /* COMMLOCALIZATIONOBJECTS_COMMVIEWPOINTLOCATIONS_ACE_H_ */
