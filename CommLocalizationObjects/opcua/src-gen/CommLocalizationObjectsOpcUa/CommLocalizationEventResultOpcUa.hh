...
template <>
ComplexType::shp_t SelfDescription(CommLocalizationObjects::CommLocalizationEventResult *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getState()), "LocalizationEventType")
	);
	return ret;
} // end SelfDescription
