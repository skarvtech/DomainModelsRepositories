...
// serialization for LocalizationEventState
template <>
ComplexType::shp_t SelfDescription(CommLocalizationObjects::LocalizationEventState *obj, std::string name)
{
	auto ret = std::make_shared<SeRoNet::CommunicationObjects::Description::ComplexType>(name);
	/// \todo check for ComplexObjects
	ret->add(
		SelfDescription(&(obj->getNewState()), "LocalizationEventType")
	);
	return ret;
} // end SelfDescription
