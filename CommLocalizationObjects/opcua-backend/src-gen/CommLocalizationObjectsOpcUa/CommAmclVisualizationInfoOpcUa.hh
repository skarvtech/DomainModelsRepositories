...
// serialization for CommAmclVisualizationInfo
template <>
inline IDescription::shp_t SelfDescription(CommLocalizationObjects::CommAmclVisualizationInfo *obj, std::string name)
{
