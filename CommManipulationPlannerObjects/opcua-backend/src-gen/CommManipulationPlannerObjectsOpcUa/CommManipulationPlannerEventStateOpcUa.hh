...
// serialization for CommManipulationPlannerEventState
template <>
inline IDescription::shp_t SelfDescription(CommManipulationPlannerObjects::CommManipulationPlannerEventState *obj, std::string name)
{
